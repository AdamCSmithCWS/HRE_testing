...
test <- foreach(i = rev(1:nrow(sp_list)),
                ...
                .errorhandling = "pass") %dopar%
  {
    ...
    if(file.exists(paste0("Indices/Inds_latlong_",aou,".rds"))){
...
# Summaries of observer and site effects by year --------------------------
      ...
      saveRDS(traj_out,file = paste0("Figures/temp_rds_storage/",aou,"_highlevel_trajs_latlong.RDS"))
                ...
                .errorhandling = "pass") %dopar%
  {
    ...
    if(file.exists(paste0("Indices/Ind_latlong_",aou,".rds"))){
     ...
     # ind <- readRDS(paste0("Indices/Ind_plot_",aou,".rds"))
      ...
      saveRDS(traj_out,file = paste0("Figures/temp_rds_storage/",aou,"_highlevel_simple_trajs_latlong.RDS"))
